...
const clientSchema = {
  ...
  style: fields.select({
    label: 'Style',
    options: [
      { label: 'Editorial', value: 'style-1-editorial' },
      { label: 'Terminal', value: 'style-2-terminal' },
      { label: 'Garden', value: 'style-3-garden' },
      { label: 'Studio', value: 'style-4-studio' },
      { label: 'Bold', value: 'style-5-bold' },
      { label: 'Industrial', value: 'style-6-industrial' },
      { label: 'Industrial Blue', value: 'style-7-industrial-blue' },
      { label: 'Corporate Red', value: 'style-8-corporate-red' },
    ],
